function initCanvas(){
    ...
    backgroundImage.src = "background-pic.jpg"; //Background picture
    naveImage.src       = "spaceship-pic.png"; //Spaceship picture
    // Enemigos fotos
    enemiespic1.src     = "enemigo1.png";
    enemiespic2.src     = "enemigo2.png"; //Enemies picture
    ...
    var enemies = [
                   new enemyTemplate({id: "enemy1", x: 100, y: -10, w: 40, h: 40 }),
                   new enemyTemplate({id: "enemy2", x: 215, y: -20, w: 50, h: 40 }),
                   new enemyTemplate({id: "enemy3", x: 350, y: -20, w: 70, h: 40 }),
                   new enemyTemplate({id: "enemy4", x:100,  y:-70,  w:70,  h: 40}),
                   new enemyTemplate({id: "enemy5", x:225,  y:-70,  w:40,  h: 40}),
                   new enemyTemplate({id: "enemy6", x:350,  y:-70,  w:40,  h: 40}),
                   new enemyTemplate({id: "enemy7", x:475,  y:-70,  w:40,  h: 40}),
                   new enemyTemplate({id: "enemy8", x:600,  y:-70,  w:70,  h: 40}),
                   new enemyTemplate({id: "enemy9", x:475,  y:-20,  w:40,  h: 40}),
                   new enemyTemplate({id: "enemy10",x: 600, y: -20, w: 40, h: 40}),

                   // Segundo grupo de enemigos
                   new enemyTemplate({ id: "enemy11", x: 100, y: -220, w: 50, h: 30, image: enemiespic2 }),
                   new enemyTemplate({ id: "enemy12", x: 235, y: -220, w: 50, h: 30, image: enemiespic2 }),
    ...
    function Launcher(){
        ...
        this.render = function () {
            ...
            if (enemies.length === 0) {
                ...
                ctx.fillText('Destruiste los virus', cW * .3 - 40, 40);
            }
        }
            ...
            for (var i = 0; i < enemies.length; i++) {
                ...
                if(m.x+m.w >= e.x && 
                   ...
                   m.y <= e.y+e.h){
                    ...
                    document.querySelector('.barra').innerHTML = "Virus "+ e.id+ " ";
                }
            }
        }
        ...
        this.hitDetectLowerLevel = function(enemy){
            ...
            if(enemy.y > 550){
                ...
                this.gameStatus.message = 'Te infectaste';
            }
            ...
            if ((enemy.y < this.y + 25 && enemy.y > this.y - 25) &&
                (enemy.x < this.x + 45 && enemy.x > this.x - 45)) { // Checking if enemy is on the left or right of spaceship
                    this.gameStatus.over = true;
                    this.gameStatus.message = 'Te contagiaste'
                }
            ...
            if(this.gameStatus.over === true){  
                ...
                ctx.fillText(this.gameStatus.message, cW * .4 - 40, 40); // text x , y
            }
        }
    }
